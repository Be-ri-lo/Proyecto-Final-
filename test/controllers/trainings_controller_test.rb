...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post trainings_url, params: { training: { active: @training.active, date: @training.date, level: @training.level, name: @training.name, place_id: @training.place_id, sport: @training.sport, user_id: @training.user_id } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { active: @training.active, date: @training.date, level: @training.level, name: @training.name, place_id: @training.place_id, sport: @training.sport, user_id: @training.user_id } }
